...
public class StoreDto implements Serializable {
    ...
    public static StoreDto fromEntity(Store store) {
        return StoreDto.builder()
                ...
                .openingTime(formatTime(store.getOpeningTime()))
                .closingTime(formatTime(store.getClosingTime()))
                .cityName(store.getDistrict().getCity().getCityName())
                .districtName(store.getDistrict().getDistrictName())
                .detailAddress(store.getDetailAddress())
                .phoneNumber(store.getPhoneNumber())
                .categoryName(store.getCategory().getCategoryName())
                .menuList(mapToMenuDTOList(store.getMenuList()))
                .build();
    }


    private static String getStoreStatus(Store store) {
    ...
    private static List<MenuDto> mapToMenuDTOList(List<Menu> menuList) {
